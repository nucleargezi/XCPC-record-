...
NAME MeIoN_is_UMP45() {
    ...
    FL::III(s, t, n + 1 << 1);
    for (int i = 1; i <= n; ++i) {
        if (i == s or i == t) FL::add(i, i + n, FL::inf);
        else FL::add(i, i + n, 1);
    }
